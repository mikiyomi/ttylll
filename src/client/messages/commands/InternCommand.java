...
public class InternCommand {
    ...
    public static class c extends chat {  
    }
    public static class gm extends chat {
    }
    public static class chat extends CommandExecute {
        
        public int execute(MapleClient c,String[] splitted) {
            if (c.getPlayer().isIntern()) {
            World.Broadcast.broadcastGMMessage(CWvsContext.serverNotice(6,">>[GMChat]" + c.getPlayer().getName() + ": " + StringUtil.joinStringFrom(splitted, 1)));
            }
            return 1;
        }
        }
