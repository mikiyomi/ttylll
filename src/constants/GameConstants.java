    ...
    public static final int ITEM_TITLE = 124000;
     ...
     public static String getCashBlockedMsg(final int id) {
        switch (id) {
            ...
            case 5062001:
                //cube
                return "This item may only be purchased in FM.";
        }
