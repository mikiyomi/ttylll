...
function action(mode, type, selection) { 
    ...
    if (mode == -1) { 
        ...
        if (mode == 1) 
            ...
            status--; 
        if (status == 0) { 
            cm.sendNext("#eHello Agent #d#h ##k. I am #rSpinel#k, master of Tier 1 Missions. Rookies like you seem useful. Alright, let's get started."); 
        } else if (status == 1) { 
            cm.sendSimple("#eAfter the attack of the Black Mage, monsters have been mutated and gone astray. I need you to hunt them down for me. If you collect the items you will recieve an eraser. Once you have gathered up all #rseven#k erasers, I will present you with a reward. \r\n#b#L0#What items do I have to collect?#l \r\n#L1#I have the Erasers.#l"); 
        } else { 
            if (selection == 0) { 
